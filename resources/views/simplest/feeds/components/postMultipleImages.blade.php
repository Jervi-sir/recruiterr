<div class="post">
    <div class="post-heading">
        <div class="post-avature">
            <img src="simplest/images/avatars/avatar-3.jpg" alt="">
        </div>
    ...
    <div class="post-description">
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-1-1@m">
                <img src="simplest/images/post/img-4.jpg" class="rounded" alt="">
            </div>
            <div class="uk-width-1-2@m uk-width-1-2">
                <img src="simplest/images/post/img-2.jpg" class="rounded" alt="">
            </div>
            <div class="uk-width-1-2@m uk-width-1-2 uk-position-relative">
                <img src="simplest/images/post/img-3.jpg" class="rounded" alt="">
        ...
        <div class="post-state-details">
            <div>
                <img src="simplest/images/icons/reactions_like.png" alt="">
                <img src="simplest/images/icons/reactions_love.png" alt="">
                <p> 13 </p>
            </div>
