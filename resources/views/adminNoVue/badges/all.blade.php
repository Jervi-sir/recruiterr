...
<div class="card">
    <div class="card-body">
        <h4 class="card-title d-flex align-items-center justify-content-between">
            <span>Badges table</span>
            <a href="{{ route('badge.add') }}" class="mt-1">
                <button class="btn btn-block btn-success"> add badge</button>
            </a>
        </h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="forms-sample" action="{{ route('badge.update') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id" v-model="modal.id">
                    <div class="form-group">
                    <label for="exampleInputUsername1">Badge name</label>
...
<div class="modal" :class="showDeleteModal ? 'd-block' : ''">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="forms-sample" action="{{ route('badge.delete') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id" v-model="modal.id">
