...
<div class="card">
    <div class="card-body">
        <h4 class="card-title d-flex align-items-center justify-content-between">
            <span>Skill table</span>
            <a href="{{ route('skill.add') }}" class="mt-1">
                <button class="btn btn-block btn-success"> add skill</button>
            </a>
        </h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="forms-sample" action="{{ route('skill.update') }}" method="POST">
                    @csrf
...
<div class="modal" :class="showDeleteModal ? 'd-block' : ''">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="forms-sample" action="{{ route('skill.delete') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id" v-model="modal.id">
